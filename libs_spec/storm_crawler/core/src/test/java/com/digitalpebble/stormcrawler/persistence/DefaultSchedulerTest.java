...
public class DefaultSchedulerTest {
    ...
    public void testScheduler() throws MalformedURLException {
        ...
        // conganh add
        Date nextFetch = scheduler.schedule(Status.FETCHED, metadata, "test");
        // end conganh
        ...
        // conganh add
        nextFetch = scheduler.schedule(Status.ERROR, metadata, "test");
        // end conganh
    ...
    public void testNever() throws MalformedURLException {
        ...
        // conganh add
        Date nextFetch = scheduler.schedule(Status.ERROR, metadata, "test");
        // end conganh
