...
``` sh
storm jar target/data-espresso-1.0-SNAPSHOT.jar com.uet.nlp.CrawlTopology -conf crawler-conf.yaml -local
```
...
``` sh
storm jar target/data-espresso-1.0-SNAPSHOT.jar  org.apache.storm.flux.Flux --local crawler.flux --sleep 86400000
```
