...
const DEFAULT_PRIORITY = [
    ...
    {
        serial: 3,
        regex: /^(\s{0,}(Ý|Câu|Bài))\s{0,}[A-Z0-9]{1,}[\.\:]{0,}[A-Z0-9]{0,}/g, // câu label
    },
    {
        serial: 4,
        regex: /^(\s{0,}[A-Z0-9]{1,})[\.\:]{1,}[A-Z0-9]{0,}/g, // câu bằng số
    },
    {
        serial: 5,
        regex: /^(\s{0,}[a-z]{1,})[\.\:]{0,}[A-Za-z0-9]{0,}\s{0,}\){1,}/g, // phần nhỏ
        inline_regex: /\s{0,1}[a-z]{1,}[\.\:]{0,}[A-Za-z0-9]{0,}\s{0,}\){1,}/g
    },
    {
        serial: 6,
        regex: /Đề \\d+/g, // các phương án trả lời
    }
]
...
class Build {
    ...
    init(string_inner_html, question_default, book) {
        ...
        this._string_inner_html = this._element.outerHTML;
        ...
        let child = this._tree.parse({id: 1});
    ...
    _buildTree(){
        for (let index = 0; index < this._abstract_solution_index; index++) {
            const child_element = this._element.children[index];

        }
        // for (let index = this._abstract_solution_index; index < this._element.children.length; index++) {
        //     const child_element = this._element.children[index];
...
<p style="text-align: justify;"><strong>Câu 1:</strong> <strong>Hãy chọn phương án trả lời đúng nhất:</strong><strong></strong></p>
...
<p style="text-align: justify;"><strong>Câu 1. Thế nào là Phân loại thực vật ? Người ta phân chia thực vật thành các bậc phân loại từ cao đến thấp theo trật tự như thế nào ?</strong></p>
<p style="text-align: justify;"><strong>Câu 2. Thế nào là thực vật quý hiếm ? Cần phải làm gì để bảo vệ đa dạng thực vật ở Việt Nam ?</strong><strong></strong></p>
